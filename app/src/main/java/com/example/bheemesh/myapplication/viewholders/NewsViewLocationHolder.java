 ...
 */
public class NewsViewLocationHolder extends RecyclerView.ViewHolder implements NewsUpdatableViewHolder {
    CardView cardItemLayout;
    TextView title, subTitle, location, category;
    OnItemClickListener clickListener;
    BaseItem placeObj;

    public NewsViewLocationHolder(View itemView, OnItemClickListener clickListener) {
        super(itemView);
