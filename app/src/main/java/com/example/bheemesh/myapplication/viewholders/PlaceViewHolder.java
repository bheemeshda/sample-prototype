...
public class PlaceViewHolder extends RecyclerView.ViewHolder implements UpdatableViewHolder {
    ...
    public PlaceViewHolder(View itemView, OnItemClickPlaceListener clickListener) {
        super(itemView);
    ...
    private void setOnclickListener(final OnItemClickPlaceListener clickListener) {
